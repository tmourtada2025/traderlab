      ...
      <div className="mx-auto max-w-7xl px-6 py-5 flex items-center justify-between gap-4">
        <Link href={home} className="flex items-center gap-3 group shrink-0">
          ...
          <div className="leading-tight">
            ...
            <div className="text-[10px] uppercase tracking-widest2 text-muted font-mono">
              Forex Academy
            </div>
          </div>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-10 text-sm">
          <Link href={home} className="link-underline">{dict.nav.home}</Link>
          <Link href={courses} className="link-underline">{dict.nav.courses}</Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="text-sm border border-ink px-4 py-2.5 hover:bg-ink hover:text-paper transition-colors inline-flex items-center gap-2"
          >
